...
namespace InkEngine {
    ...
    public class InkListener : MonoBehaviour {
        ...
        public virtual void Start () {
            ...
            if (m_listenTarget == null) {
                Debug.LogError ("No story object assigned to listener! Please assign a story object to it in the editor.");
            }
            Debug.Log ("Adding new listeners!");
        ...
        void OnDestroy () {
            m_listenTarget.m_textFunctionFoundEvent.RemoveListener (OnFunctionEvent);
            m_listenTarget.m_inkTagFoundEvent.RemoveListener (OnTagEvent);
        }
